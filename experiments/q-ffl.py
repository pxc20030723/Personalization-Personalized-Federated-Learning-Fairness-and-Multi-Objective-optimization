...
def main():
    ...
    with open(os.path.join(RESULT_DIR, 'best_lambda_qffl.txt')) as f:
        LAMBDA = float(f.read())
    ...
    # output_dir = '/Users/xinchepeng/Documents/Github_projects/18667_project/results/qffl'
    output_dir = os.path.join(BASE_DIR, 'results', 'qffl')
